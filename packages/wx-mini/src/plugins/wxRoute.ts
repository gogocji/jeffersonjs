import { ErrorTypes, WxBaseEventTypes, WxBreadcrumbTypes, WxEventTypes, WxRouteEvents } from '../../../shared/src/index'
import { getCurrentRoute, Severity, variableTypeDetection } from '../../../utils/src/index'

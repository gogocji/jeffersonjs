...
import { BreadcrumbPushData, EMethods, ReportDataType, TransportDataType, Replace } from '@jfsonjs/types'
import automator from 'miniprogram-automator'
import { resolve } from 'path'
import { Severity } from '@mitojs/utils'
import { BREADCRUMBCATEGORYS, BREADCRUMBTYPES, ERRORTYPES, HTTPTYPE, SDK_NAME, SDK_VERSION } from '@jfsonjs/shared'
